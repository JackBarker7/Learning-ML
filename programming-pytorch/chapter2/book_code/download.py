# download.py
# copied from https://github.com/falloutdurham/beginners-pytorch-deep-learning/blob/master/chapter2/download.py
...
p = Path(__file__).with_name('images.csv')
filename = p.absolute()
